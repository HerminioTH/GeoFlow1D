...
folder_results = "results\\POISSON\\"
# -----------------------------------------------------
...
restart = num_set.get("SplitMethod").get("Restart")
d = num_set.get("SplitMethod").get("Relaxation")
# d = 1. + 4*G/bulk/3.
delta = Delta(d, step, reductionFactor, restart)
...
folder_results += method_split + "_" + str(nu) + "\\"
# -----------------------------------------------------
