...
# -------------- PROPERTIES ---------------------------
fluid = getJsonData("settings\\properties_fluid.json")
...
solid = getJsonData("settings\\properties_solid.json")
...
# ---------------- INITIAL FIELDS ---------------------
ic = getJsonData("settings\\IC.json")
...
# ------------- BOUNDARY CONDITIONS -------------------
bound_p = getJsonData("settings\\BC_p.json")
bound_u = getJsonData("settings\\BC_u.json")
# -----------------------------------------------------
